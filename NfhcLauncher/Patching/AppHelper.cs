        ...
        public static void RestartAsAdmin()
        {
            if (!IsAppRunningInAdmin())
            {
                MessageBoxResult result = MessageBox.Show(
                    "Nfhc launcher should be executed with administrator permissions in order to properly patch NFH while in Program Files directory, do you want to restart ?",
                    "Nfhc needs permissions",
